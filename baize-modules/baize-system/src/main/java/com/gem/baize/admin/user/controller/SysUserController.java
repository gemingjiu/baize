...
import com.gem.baize.admin.user.service.SysUserService;
import com.gem.baize.api.admin.user.domain.dto.UserDTO;
import com.gem.baize.api.admin.user.domain.vo.SysUserVO;
...
public class SysUserController {
    ...
    public Result<Page<SysUserVO>> page(@RequestParam(value = "current", defaultValue = "1") int current, @RequestParam(value = "size", defaultValue = "10") int size, @Valid @RequestBody UserDTO dto) {
