...
public class ServletUtils {
    ...
    public static Integer getParameterToInt(String name) {
        return com.baize.common.core.utils.ConvertUtils.toInt(getRequest().getParameter(name));
    }
    ...
    public static Boolean getParameterToBool(String name) {
        return com.baize.common.core.utils.ConvertUtils.toBool(getRequest().getParameter(name));
    }
    ...
    public static String urlEncode(String str) {
        try {
            return URLEncoder.encode(str, com.baize.common.core.constant.Constants.UTF8);
    ...
    public static String urlDecode(String str) {
        try {
            return URLDecoder.decode(str, com.baize.common.core.constant.Constants.UTF8);
        } catch (UnsupportedEncodingException e) {
            return StringUtils.EMPTY;
        }
    }
    ...
    public static Mono<Void> webFluxResponseWriter(ServerHttpResponse response, Object value) {
        return webFluxResponseWriter(response, HttpStatus.OK, value, Response.FAIL);
    }
