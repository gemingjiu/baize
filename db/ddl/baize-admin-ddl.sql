...
CREATE TABLE sys_config(
                           ...
                           config_type VARCHAR(1) NOT NULL DEFAULT '0',
                           sort INT4,
...
COMMENT ON COLUMN sys_config.config_type IS '系统内置;系统内置（0否 1是）';
...
CREATE  UNIQUE INDEX sys_config_name_ukey ON sys_config (
                                                         tenant_id ASC,
                                                         config_name ASC
    );
CREATE  UNIQUE INDEX sys_config_key_ukey ON sys_config (
                                                        tenant_id ASC,
                                                        config_key ASC
    );
...
CREATE  UNIQUE INDEX sys_dept_ukey ON sys_dept (
                                                tenant_id ASC,
                                                dept_name ASC
    );
...
CREATE  UNIQUE INDEX sys_dict_type_name_ukey ON sys_dict_type (
                                                               tenant_id ASC,
                                                               dict_name ASC
    );
CREATE  UNIQUE INDEX sys_dict_type_type_ukey ON sys_dict_type (
                                                               tenant_id ASC,
                                                               dict_type ASC
    );
...
CREATE  UNIQUE INDEX sys_data_perm_ukey ON sys_data_perm (
                                                          tenant_id ASC,
                                                          rule_name ASC
    );
...
CREATE  UNIQUE INDEX sys_dict_data_ukey ON sys_dict_data (
                                                          tenant_id ASC,
                                                          dict_label ASC
    );
...
CREATE  UNIQUE INDEX sys_menu_ukey ON sys_menu (
                                                tenant_id ASC,
                                                menu_name ASC
    );
...
CREATE  UNIQUE INDEX sys_perm_name_ukey ON sys_perm (
                                                     tenant_id ASC,
                                                     perm_name ASC
    );
CREATE  UNIQUE INDEX sys_perm_code_ukey ON sys_perm (
                                                     tenant_id ASC,
                                                     perm_code ASC
    );
...
CREATE  UNIQUE INDEX sys_post_name_ukey ON sys_post (
                                                     tenant_id ASC,
                                                     post_name ASC
    );
CREATE  UNIQUE INDEX sys_post_code_ukey ON sys_post (
                                                     tenant_id ASC,
                                                     post_code ASC
    );
...
CREATE TABLE sys_role(
                         ...
                         menu_check_strictly VARCHAR(1) NOT NULL DEFAULT '1',
                         dept_check_strictly VARCHAR(1) NOT NULL DEFAULT '1',
                         sort INT4,
                         status VARCHAR(1) NOT NULL DEFAULT '0',
                         deleted VARCHAR(1) NOT NULL DEFAULT '0',
                         version INT4 NOT NULL,
...
CREATE  UNIQUE INDEX sys_role_name_ukey ON sys_role (
                                                     tenant_id ASC,
                                                     role_name ASC
    );
CREATE  UNIQUE INDEX sys_role_code_ukey ON sys_role (
                                                     tenant_id ASC,
                                                     role_code ASC
    );
...
CREATE  UNIQUE INDEX sys_roel_dept_ukey ON sys_role_dept (
                                                          role_id ASC,
                                                          dept_id ASC
    );
...
CREATE INDEX sys_role_menu_ukey ON sys_role_menu (
                                                  role_id ASC,
                                                  menu_id ASC
    );
...
CREATE  UNIQUE INDEX sys_role_perm_ukey ON sys_role_perm (
                                                          role_id ASC,
                                                          perm_id ASC
    );
...
CREATE TABLE sys_user(
                         ...
                         password VARCHAR(90) DEFAULT '',
                         login_ip VARCHAR(90) DEFAULT '',
...
CREATE  UNIQUE INDEX sys_user_ukey ON sys_user (
                                                tenant_id ASC,
                                                user_name ASC
    );
...
COMMENT ON COLUMN sys_tenant.sort IS '显示顺序';
...
CREATE  UNIQUE INDEX sys_tenant_name_ukey ON sys_tenant (
                                                         tenant_name ASC
    );
...
CREATE  UNIQUE INDEX sys_user_post_ukey ON sys_user_post (
                                                          user_id ASC,
                                                          post_id ASC
    );
...
CREATE  UNIQUE INDEX sys_user_role_ukey ON sys_user_role (
                                                          user_id ASC,
                                                          role_id ASC
    );
